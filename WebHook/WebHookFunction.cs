...
namespace WebHook
{
    public static class WebHookFunction
    {
        ...
        public static async Task<IActionResult> Run(
            ...
            [Queue("compressimagesmessage")] ICollector<RouterMessage> routerMessages,
            ...
            TraceWriter log)
        {
            ...
            switch (hookEvent)
            {
                ...
                case "integration_installation":
                    ...
                    break;
                case "push":
                    result = ProcessPush(hook, routerMessages);
                    break;
        ...
        private static string ProcessPush(Hook hook, ICollector<RouterMessage> routerMessages)
        {
